...
public class Tweet extends AppCompatActivity implements OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                loginLayout.setVisibility(View.GONE);
                shareLayout.setVisibility(View.VISIBLE);
                userName.setText(Tweet.this.getResources().getString(
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Tweet.this);
        ...
        protected Void doInBackground(String... args) {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(+R.drawable.trophy);
                statusUpdate.setMedia("trophy.png", is);
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(Tweet.this, "Posted to Twitter!", Toast.LENGTH_SHORT).show();
